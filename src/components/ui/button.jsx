...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[6px] text-sm font-medium transition-all cursor-pointer disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-white hover:bg-primary/90 disabled:bg-[#EAEAEA] disabled:text-[#8E8E8E] disabled:hover:bg-[#EAEAEA]",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 disabled:bg-[#EAEAEA] disabled:text-[#8E8E8E]",
        outline:
          "border border-primary bg-transparent text-primary disabled:bg-[#EAEAEA] disabled:text-[#8E8E8E] disabled:border-[#EAEAEA]",
        secondary:
        ...
        link: "text-primary underline-offset-4 hover:underline disabled:text-[#8E8E8E] disabled:no-underline",
      },
      size: {
