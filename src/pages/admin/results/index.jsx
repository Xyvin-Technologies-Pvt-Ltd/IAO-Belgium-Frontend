...
const Results = () => {
  ...
  // Fetch results based on active page and filters
  const {
    data: resultsData,
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      link.setAttribute("download", `exam_results_${moment().format("YYYYMMDD_HHmmss")}.csv`);
  ...
  return (
    <div className="space-y-6 mt-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button onClick={handleExport} className="flex items-center gap-2 self-start sm:self-auto bg-[#ff8904] hover:bg-[#ff8904]/90 text-white font-medium">
